...
export const selectedWorks: SelectedWork[] = [
  ...
  {
    id: "jewel-2048",
    category: "AI AGENT SIDE PROJECT",
    number: "02",
    title: "Jewel 2048｜寶石合成小遊戲",
    description: "透過 AI Agent 協作完成的互動小遊戲。合成寶石、挑戰高分，並加入清脆的水晶音效，讓快速連續合成也成為遊戲體驗的一部分。",
    cta: "立即體驗",
    alt: "Jewel 2048 寶石合成小遊戲試玩影片",
    kind: "preview",
    videoUrl: "/videos/Jewel2048.mp4",
    href: "https://resonant-jewels-2048.vercel.app/",
  },
  {
